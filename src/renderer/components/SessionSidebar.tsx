...
import { Plus, LayoutGrid, Monitor, PanelLeftClose, Settings, SquareTerminal, ChevronDown, ChevronRight } from 'lucide-react'
  ...
  return (
    <div className="mb-1">
      <button
        ...
        className="w-full flex items-center gap-1.5 px-2 py-1.5 rounded transition-colors duration-100 hover:bg-[rgba(255,255,255,0.02)]"
      >
        {open ? (
        ...
        {icon}
        <span
          className="text-[10px] uppercase tracking-[1px] font-semibold flex-1 text-left"
...
export default function SessionSidebar(): React.JSX.Element {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="px-3 pt-3 pb-2 flex items-center gap-1.5 flex-shrink-0">
        <button
      ...
      <div className="flex-1 overflow-y-auto px-2 py-1 min-h-0">
        ...
        {shellSessions.length > 0 && (
          <Category
            icon={<SquareTerminal size={12} style={{ color: 'var(--text-secondary)' }} />}
            label="Shell"
