...
import type { AiProvider, ClaudeConfigRoute } from '../../../shared/types'
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      >
        <div className="p-4">
          ...
          {enabledProviders.includes('claude') && (
            <>
              ...
              <button
                onClick={() => setClaudeSettingsOpen(!claudeSettingsOpen)}
                className="flex items-center gap-1 mt-3 text-[10px] font-medium transition-colors hover:text-[var(--accent)]"
                style={{ color: 'var(--text-muted)' }}
              >
                {claudeSettingsOpen ? <ChevronDown size={12} /> : <ChevronRight size={12} />}
                Settings
              </button>
            </>
          )}
        ...
        {enabledProviders.includes('claude') && claudeSettingsOpen && (
          <div
          ...
          >
              ...
              <div>
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  <span className="text-xs" style={{ color: 'var(--text-primary)' }}>
                    Enable auto mode by default for new sessions
                  </span>
                </label>
            ...
            <div>
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-xs" style={{ color: 'var(--text-primary)' }}>
                  Pass --dangerously-skip-permissions to new sessions
                </span>
              </label>
            ...
            <div>
              <h3 className="text-xs font-medium mb-2" style={{ color: 'var(--text-primary)' }}>Config Routing</h3>
